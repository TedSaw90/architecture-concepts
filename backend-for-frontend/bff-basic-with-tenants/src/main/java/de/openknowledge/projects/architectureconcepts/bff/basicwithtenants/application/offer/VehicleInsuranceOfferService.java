...
import de.openknowledge.projects.architectureconcepts.bff.basicwithtenants.application.backendservice.OfferClient;
import de.openknowledge.projects.architectureconcepts.bff.basicwithtenants.application.backendservice.OfferClientRequestDTO;
import de.openknowledge.projects.architectureconcepts.bff.basicwithtenants.application.backendservice.OfferClientResponseDTO;
import de.openknowledge.projects.architectureconcepts.bff.basicwithtenants.infrastructure.stereotypes.ApplicationService;
...
public class VehicleInsuranceOfferService {
  ...
  public OfferResponseDTO tariff(final OfferRequestDTO offerRequest, final Tenant tenant) {
    LOGGER.debug("Tariff vehicle insurance");

    OfferClientRequestDTO offerClientRequest = mapRequest(offerRequest, tenant);
  ...
  private OfferClientRequestDTO mapRequest(final OfferRequestDTO offerRequest, final Tenant tenant) {
