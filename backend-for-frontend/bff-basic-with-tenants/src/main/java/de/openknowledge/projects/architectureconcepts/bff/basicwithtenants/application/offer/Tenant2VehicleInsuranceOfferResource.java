...
import static de.openknowledge.projects.architectureconcepts.bff.basicwithtenants.infrastructure.tenant.TenantType.TENANT_2;
 ...
 */
@Path("/tenant2/offers")
public class Tenant2VehicleInsuranceOfferResource {

  private static final Logger LOGGER = LoggerFactory.getLogger(Tenant2VehicleInsuranceOfferResource.class);

  @Inject
  @TenantQualifier(TENANT_2)
